...
There are 2 RSpec tests:  1 controller test and 1 model test using RSpec
Run the test from the command line: rspec spec

There is one cucumber test for pet.
Run the test from the command line: rake cucumber

They are just to show that I know how to write test :))
